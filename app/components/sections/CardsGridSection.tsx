...
export default function CardsGridSection({ content }: Props) {
  const heading = (content.heading as string) || '';
  const subtitle = (content.subtitle as string) || '';
  const cards = (content.cards as { title: string; description: string; image?: string; color?: string; badge?: string }[]) || [];
